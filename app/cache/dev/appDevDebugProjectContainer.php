...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'WeddingManageBundle' => 'Wedding\\ManageBundle\\WeddingManageBundle',
            ...
            'assetic.filter.scssphp.formatter' => NULL,
            ...
            'braincrafted_bootstrap.assets_dir' => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets'),
            ...
            'braincrafted_bootstrap.less_filter' => 'scssphp',
        ...
        $this->methodMap = array(
            ...
            'wedding.form.type.rsvp' => 'getWedding_Form_Type_RsvpService',
        );
        $this->aliases = array(
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('bootstrap_css' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/stylesheets/_bootstrap.scss'), 1 => (dirname(dirname(__DIR__)).'/../vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/Resources/less/form.less')), 1 => array(0 => 'scssphp', 1 => 'cssrewrite'), 2 => array('output' => 'css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/transition.js'), 1 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/alert.js'), 2 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/button.js'), 3 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/carousel.js'), 4 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/collapse.js'), 5 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/dropdown.js'), 6 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/modal.js'), 7 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/tooltip.js'), 8 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/popover.js'), 9 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/scrollspy.js'), 10 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/tab.js'), 11 => (dirname(dirname(__DIR__)).'/../vendor/twbs/bootstrap-sass/assets/javascripts/bootstrap/affix.js'), 12 => (dirname(dirname(__DIR__)).'/../vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/Resources/js/bc-bootstrap-collection.js')), 1 => array(), 2 => array('output' => 'js/bootstrap.js')), 'jquery' => array(0 => array(0 => (dirname(dirname(__DIR__)).'/../vendor/jquery/jquery/jquery-1.10.2.js')), 1 => array(), 2 => array('output' => 'js/jquery.js')))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WeddingManageBundle', (dirname(dirname(__DIR__)).'/Resources/WeddingManageBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WeddingManageBundle', (dirname(dirname(dirname(__DIR__))).'/src/Wedding/ManageBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'scssphp' => 'assetic.filter.scssphp'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'wedding', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Wedding/ManageBundle/Entity'))), 'Wedding\\ManageBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('WeddingManageBundle' => 'Wedding\\ManageBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_25b124b89900f14e9bfba8c4a532739ff61c9dfeb78fd154f7267a312a812ee7');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.default' => NULL, 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => $d, 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54f85f4483846', $b, $this->get('security.authentication.manager')), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $c, 'secured_area', NULL, NULL, NULL, $b));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'WeddingManageBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(__DIR__)).'/Resources/BraincraftedBootstrapBundle/views'), 'BraincraftedBootstrap');
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Wedding/ManageBundle/Resources/views'), 'WeddingManage');
    ...
    /**
     * Gets the 'wedding.form.type.rsvp' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Wedding\ManageBundle\Form\Type\RsvpType A Wedding\ManageBundle\Form\Type\RsvpType instance.
     */
    protected function getWedding_Form_Type_RsvpService()
    {
        return $this->services['wedding.form.type.rsvp'] = new \Wedding\ManageBundle\Form\Type\RsvpType();
    }
    ...
    protected function getAssetic_AssetFactoryService()
    {
        ...
        $instance->addWorker(new \Assetic\Factory\Worker\EnsureFilterWorker('/\\.scss$/', $this->get('assetic.filter.scssphp')));
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2y$13$nRUgVEe9nCKjzYrwjebFeeqOPElS5V4W2Y0c1VUmwoQ.SzChK/.j.', array(0 => 'ROLE_ADMIN')));
