...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/329c1f8')) {
            // _assetic_329c1f8
            if ($pathinfo === '/css/329c1f8.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '329c1f8',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_329c1f8',);
            }

            if (0 === strpos($pathinfo, '/css/329c1f8_')) {
                // _assetic_329c1f8_0
                if ($pathinfo === '/css/329c1f8_bootstrap_1.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '329c1f8',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_329c1f8_0',);
                }

                // _assetic_329c1f8_1
                if ($pathinfo === '/css/329c1f8_custom_2.css') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '329c1f8',  'pos' => 1,  '_format' => 'css',  '_route' => '_assetic_329c1f8_1',);
                }
        ...
        if (0 === strpos($pathinfo, '/js/e3f150f')) {
            // _assetic_e3f150f
            if ($pathinfo === '/js/e3f150f.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3f150f',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_e3f150f',);
            }

            // _assetic_e3f150f_0
            if ($pathinfo === '/js/e3f150f_custom_1.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'e3f150f',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_e3f150f_0',);
            }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (rtrim($pathinfo, '/') === '/admin') {
                ...
                return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\AdminController::indexAction',  '_route' => 'admin_index',);
            }

            if (0 === strpos($pathinfo, '/admin/rsvp')) {
                // admin_rsvp_edit
                if (preg_match('#^/admin/rsvp/(?P<rsvp>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_rsvp_edit')), array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\AdminController::editAction',));
                }

                // admin_rsvp_remove
                if (preg_match('#^/admin/rsvp/(?P<rsvp>[^/]++)/remove$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_rsvp_remove')), array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\AdminController::removeAction',));
                }
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::indexAction',  '_route' => 'index',);
        }

        // rsvp
        if ($pathinfo === '/rsvp') {
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::rsvpAction',  '_route' => 'rsvp',);
        }

        // about
        if ($pathinfo === '/about') {
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::aboutAction',  '_route' => 'about',);
        }

        // directions
        if ($pathinfo === '/directions') {
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::directionsAction',  '_route' => 'directions',);
        }

        // honeymoon
        if ($pathinfo === '/honeymoon') {
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::honeymoonAction',  '_route' => 'honeymoon',);
        }

        // photos
        if ($pathinfo === '/photos') {
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::photosAction',  '_route' => 'photos',);
        }

        // registries
        if ($pathinfo === '/registries') {
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::registriesAction',  '_route' => 'registries',);
        }

        // contact
        if ($pathinfo === '/contact') {
            return array (  '_controller' => 'Wedding\\ManageBundle\\Controller\\PublicController::contactAction',  '_route' => 'contact',);
        }
